...
export class EventService {
  EVENTS: IEvent[] = [
    ...
    },
    {
      ...
      price: 999.99,
      imageUrl: "/assets/images/angularconnect-shield.png",
      onlineUrl: "http://ng-india.in/",
      sessions: [
        {
          id: 1,
          name: "Angular 12 Fundamentals",
          presenter: "Jaganmohanreddy",
          duration: 1,
          level: "Beginner",
          abstract: `Learn all about the fundamentals of Angular 12,  
          how to create a project, build, serve and deploy with Angular CLI`,
          voters: ["bradgreen", "igorminar", "martinfowler"]
        },
        {
          id: 2,
